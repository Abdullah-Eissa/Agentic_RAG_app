...
async def answer_rag(request: Request, project_id: str, search_request: SearchRequest):
    ...
    if search_request.context_aware_answer:
        full_chat_history = await chat_history_model.get_chat_history(project_id=project.project_id)
    else:
        full_chat_history = None


    answer, full_prompt, chat_history, documents, answer_source, sub_queries, data_sources = await nlp_controller.answer_rag_question(
        project=project,
    ...
    chat_history_record = ChatHistory(
        chat_project_id=project.project_id,
        query=search_request.text,
        answer=answer
    )
